...
<form method="post" action="/auth/login" style="display:grid;gap:10px">
  ...
  <label>
    ...
    <div class="pwd-wrap">
      ...
      <button type="button" id="pwdToggle" class="pwd-toggle" aria-label="Toggle password visibility">
        <svg viewBox="0 0 24 24" aria-hidden="true" class="eye-open">
    ...
    <div style="text-align: right; margin-top: 4px; font-size: 0.85rem;">
      <a href="/auth/forgot-password" style="color: #3aa0ff; text-decoration: none;">Forgot password?</a>
    </div>
  </label>
